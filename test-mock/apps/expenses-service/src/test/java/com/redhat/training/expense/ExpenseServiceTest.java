...
public class ExpenseServiceTest {
    ...
    public void testDeleteNotFoundExpense(){
        UUID nonExistingUuid = UUID.fromString("896bca62-b865-4e04-bc45-d028c44b381a");
        PanacheMock.mock(Expense.class);
        Mockito.when(Expense.delete("uuid", nonExistingUuid)).thenReturn(0L);
        ExpenseService expenseService = new ExpenseService();
        Assertions.assertThrows(WebApplicationException.class, ()->expenseService.delete(nonExistingUuid));    
    }
